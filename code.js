...
Code.tabClick = function(clickedName) {
  ...
  if (document.getElementById('tab_xml') && document.getElementById('tab_xml').className == 'tabon') {
...
xhttp.open("POST","/runProgram",true);
xhttp.send(Blockly.Python.workspaceToCode(Code.workspace));
};
